...
# Explicitly import requested class in case * didn't get it
from transformers.models.clip.modeling_clip import CLIPVisionEmbeddings, CLIPTextTransformer, CLIPPreTrainedModel, CLIPMLP, CLIPOutput
