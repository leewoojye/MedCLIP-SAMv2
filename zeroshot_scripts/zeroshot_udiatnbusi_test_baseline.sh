...
SAL_PATH="saliency_map_outputs/UDIATnBUSI_TEST_Baseline_HF/test_masks"
COARSE_PATH="coarse_outputs/UDIATnBUSI_TEST_Baseline_HF/test_masks"
SAM_PATH="sam_outputs/UDIATnBUSI_TEST_Baseline_HF/test_masks"
