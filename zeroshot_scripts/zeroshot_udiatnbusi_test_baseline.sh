...
# UDIATnBUSI_TEST Baseline Inference Script
...
SAL_PATH="saliency_map_outputs/UDIAT7nBUSI7_aug_TEST_Baseline_HF/test_masks"
COARSE_PATH="coarse_outputs/UDIAT7nBUSI7_aug_TEST_Baseline_HF/test_masks"
SAM_PATH="sam_outputs/UDIAT7nBUSI7_aug_TEST_Baseline_HF/test_masks"
