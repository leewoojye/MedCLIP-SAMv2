...
# BUSI_TEST DHN Inference Script
...
SAL_PATH="saliency_map_outputs/BUSI_TEST_DHN_HF/test_masks"
COARSE_PATH="coarse_outputs/BUSI_TEST_DHN_HF/test_masks"
SAM_PATH="sam_outputs/BUSI_TEST_DHN_HF/test_masks"
