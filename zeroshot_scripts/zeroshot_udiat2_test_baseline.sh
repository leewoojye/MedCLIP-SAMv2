...
# UDIAT2 (All UDIAT) Baseline Inference Script
...
SAL_PATH="saliency_map_outputs/UDIAT2_Baseline_HF/test_masks"
COARSE_PATH="coarse_outputs/UDIAT2_Baseline_HF/test_masks"
SAM_PATH="sam_outputs/UDIAT2_Baseline_HF/test_masks"
...
echo "UDIAT2 Baseline Inference Complete."
