...
# UDIAT2 (All UDIAT) DPO Inference Script
# Target: 163 test images in UDIAT2/test_images
...
DATASET="$ROOT_DIR/UDIAT2"
JSON_PROMPTS="$ROOT_DIR/saliency_maps/text_prompts/udiat2_test_prompts.json"
CHECKPOINT="$ROOT_DIR/biomedclip_finetuning/open_clip/src/logs/biomedclip_dpo_udiat_v28/best_params"

SAL_PATH="saliency_map_outputs/UDIAT2_DPO_v28_HF/test_masks"
COARSE_PATH="coarse_outputs/UDIAT2_DPO_v28_HF/test_masks"
SAM_PATH="sam_outputs/UDIAT2_DPO_v28_HF/test_masks"
...
echo "UDIAT2 DPO Inference Complete."
