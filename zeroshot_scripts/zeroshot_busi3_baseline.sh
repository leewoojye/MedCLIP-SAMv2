...
SAL_PATH="saliency_map_outputs/BUSI3_Baseline_HF/test_masks"
COARSE_PATH="coarse_outputs/BUSI3_Baseline_HF/test_masks"
SAM_PATH="sam_outputs/BUSI3_Baseline_HF/test_masks"
