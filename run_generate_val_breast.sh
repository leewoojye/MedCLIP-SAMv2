#!/bin/bash
# Generate Healthy Samples (Validation Set)
# Source: data/breast_tumors/val_images
# Target: generated_neg_output/breast_val_ddbm
...
OUTPUT_DIR="generated_neg_output/breast_val_ddbm"
PROMPT="healthy breast tissue, no tumor, normal mammogram"

mkdir -p $OUTPUT_DIR

echo "Generating Healthy Samples for 10 Validation Images..."
