...
# Run negative sample generation for all breast tumor test images.

ROOT_DIR="/home/woojye2020/decs_jupyter_lab/MedCLIP-SAMv2"
IMG_DIR="$ROOT_DIR/data/breast_tumors/test_images"
MASK_DIR="$ROOT_DIR/data/breast_tumors/test_masks"
OUT_DIR="$ROOT_DIR/generated_neg_output/breast_tumors"
...
img_dir = root / "data/breast_tumors/test_images"
mask_dir = root / "data/breast_tumors/test_masks"
out_dir = root / "generated_neg_output/breast_tumors"
...
for img_path in images:
    ...
    generate_healthy_ultrasound(str(img_path), str(mask_path), str(out_dir))
