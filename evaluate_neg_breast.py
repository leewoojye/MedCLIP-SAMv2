...
# Path setup
original_dir = "data/breast_tumors/test_images"
generated_dir = "generated_neg_output/breast_tumors"

# Text Prompts (Ultrasound specific)
prompts = ["a breast ultrasound with a tumor", "a healthy breast ultrasound"]
