...
OUT_DIR="$ROOT_DIR/generated_neg_output/udiat_breast_biomedclip1.0v3"
COMPARE_DIR="$OUT_DIR/comparisons"
CKPT_PATH="$ROOT_DIR/zero_shot_translation/sd_biomedclip_ckpt/best.pt"
DILATE_MASK="3"
TUMOR_ANCHOR="brain MRI with glioblastoma tumor or mass"
...
for img_path in images:
    ...
    cmd = [
        ...
        "--healthy_anchor", "healthy normal brain MRI, completely clear",
        "--alpha", "1.0", # Direct generation without shift vector is fully supported now
