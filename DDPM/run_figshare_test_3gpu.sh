...
OUTPUT_DIR="${PROJECT_ROOT}/generated_neg_output/figshare_test_ddpm_step122000"
LOG_DIR="${PROJECT_ROOT}/DDPM/logs/figshare_test_ddpm_step122000"
WORLD_SIZE=3
GPUS=(0 1 2)
...
for rank in 0 1 2; do
    ...
    CUDA_VISIBLE_DEVICES="${gpu}" "${PYTHON}" -u -m DDPM.sample_figshare_sharded \
        --image-dir "${IMAGE_DIR}" \
        --mask-dir "${MASK_DIR}" \
